            ...
            case GameMode.PLAYER_VS_PLAYER:
                self.buttons.extend([
                    ClickButton("Start Game", 
                        ...
                        action=lambda: self.game.change_state("game", mode=self.gameMode, board=self.board)),
            ...
            case GameMode.PLAYER_VS_AI:
                self.buttons.extend([
                    ...
                    ClickButton("Start Game", 
                        ...
                        FONT,
                        LIGHT_CYAN, STEEL_BLUE, POWER_BLUE, WHITE, CADET_BLUE, CADET_BLUE,
                        action=lambda: self.game.change_state("game", mode=self.gameMode, board=self.board, player=self.start_piece , bot1_mode=self.bot1_mode,
            ...
            case GameMode.AI_VS_AI:
                self.buttons.extend([ 
                    ...
                    ClickButton("Start Game", 
                        ...
                        FONT,
                        LIGHT_CYAN, STEEL_BLUE, POWER_BLUE, WHITE, CADET_BLUE, CADET_BLUE,
                        action=lambda: self.game.change_state("game", mode=self.gameMode, board=self.board, bot1_mode=self.bot1_mode, bot2_mode=self.bot2_mode,
                                                              bot1_difficulty=self.bot1_minMax if self.bot1_mode == "MinMax" else self.bot1_monteCarlo,
